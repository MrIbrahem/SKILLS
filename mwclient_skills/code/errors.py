...
class ProtectedPageError(EditError, InsufficientPermission):
    ...
    Attributes:
        page (page.Page): The page for which the edit attempt was made.
        code (Optional[str]): The error code returned by the API.
...
class LoginError(MwClientError):
    ...
    Attributes:
        site (site.Site): The site object on which the login attempt
            was made.
    ...
    def __init__(
        self, site: "Site", code: Optional[str], info: str
    ) -> None:
        super().__init__(
