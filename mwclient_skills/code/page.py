...
class Page:
    ...
    :class:`~client.Site` object.

    Args:
        site (client.Site): The site object this page belongs to.
    ...
    def __init__(
        ...
        if "invalid" in info:
            raise errors.InvalidPageTitle(info.get("invalidreason"))
    ...
    def _edit(
        ...
        **kwargs: Any,
        ...
        if not self.site.logged_in and self.site.force_login:
            raise errors.AssertUserFailedError()
    ...
    def handle_edit_error(
        self, e: "errors.APIError", summary: str
    ) -> NoReturn:
    ...
    def categories(
        ...
        "listing.PagePropertyGenerator", "listing.PageProperty"
    ]:
    ...
    def extlinks(self) -> "listing.PageProperty":
    ...
    def iwlinks(self) -> "listing.PageProperty":
    ...
    def langlinks(self, **kwargs: Any) -> "listing.PageProperty":
    ...
    def links(
        ...
        kwargs = dict(
            listing.List.generate_kwargs(prefix, namespace=namespace)
        )
    ...
    def templates(
        ...
        if generator:
            return listing.PagePropertyGenerator(
                self, "templates", "tl", **kwargs
            )
        else:
            return listing.PageProperty(
                self, "templates", "tl", return_values="title", **kwargs
            )
